...
> - **[`protocol/bank-schema.md`](./protocol/bank-schema.md)** — banking document schemas (`Voucher`, `Account`, `Record`, `Tx`, `Order`, `Offer`, `Subscription`) and ledger semantics (state machine, concurrency, balance invariants).
